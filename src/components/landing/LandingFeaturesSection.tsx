...
const features = [
  {
    ...
    description:
      "AI-powered search across knowledge, services, people, and work items.",
  },
  {
    icon: Sparkles,
    ...
    description:
      "Manage tasks, requests, and workflows from one governed workspace.",
  },
  {
    icon: Bell,
    ...
    title: "Stay informed",
    description:
      "Personalised updates, briefs, and insights delivered where you work.",
  },
];
...
const FEATURES_WORKSPACE_IMAGE =
  "https://images.unsplash.com/photo-1696087225391-eb97abf5ba20?q=80&w=1563&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-md text-base leading-7 text-text-secondary">
              A central hub that connects your daily work from discovering
              services and knowledge to tracking tasks and collaborating with
              your team.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-[520px]">
            <div className="relative aspect-[5/4] overflow-hidden rounded-[24px] bg-[#F4F6FA] shadow-lg">
              {/* Workspace scene */}
              <img
                src={FEATURES_WORKSPACE_IMAGE}
                alt="Modern digital workspace with laptop, monitor, and collaborative tools"
                className="absolute inset-0 h-full w-full object-cover object-center"
              />
              <div
                className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#030F35]/25 via-transparent to-[#030F35]/10"
                aria-hidden
              />

              {/* Floating cards */}
              <FeatureCard className="absolute left-3 top-5 z-20 w-[178px] sm:left-4 sm:top-6">
                <CardHeader
              ...
              <FeatureCard className="absolute right-3 top-8 z-20 w-[196px] sm:right-4 sm:top-10">
                <CardHeader
              ...
              <FeatureCard className="absolute bottom-5 left-2 z-30 w-[168px] sm:bottom-6 sm:left-3">
                <CardHeader
              ...
              <FeatureCard className="absolute bottom-4 right-2 z-30 w-[186px] sm:bottom-5 sm:right-3">
                <CardHeader
