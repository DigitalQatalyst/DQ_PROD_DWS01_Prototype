...
export function WorkingSessionsPage() {
  ...
  return <RolePageScaffold eyebrow="Agile Execution" title="Working Sessions" purpose="Manage team ceremonies, capture actions, and record decisions." primaryAction={{
    label: 'New Session',
