...
const mockPlaybooks = [{
  id: 'KNO-006',
  title: 'Executive Onboarding Playbook',
  type: 'Playbook'
}];
export function OnboardingPlaybooksPage() {
  ...
  return <RolePageScaffold eyebrow="Knowledge" title="Onboarding Playbooks" purpose="Role-specific playbooks for structured onboarding.">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockPlaybooks.map((k) => <div key={k.id} className="bg-white rounded-[12px] border border-[#D8D9E6] p-5 hover:shadow-md transition-shadow cursor-pointer group" onClick={() => toast.success('Playbook opened')}>
