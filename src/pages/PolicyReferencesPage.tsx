...
export function PolicyReferencesPage() {
  ...
  return <RolePageScaffold eyebrow="Knowledge" title="Policy References" purpose="Core HR and compliance policies.">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockPolicies.map((k) => <div key={k.id} className="bg-white rounded-[12px] border border-[#D8D9E6] p-5 hover:shadow-md transition-shadow cursor-pointer group" onClick={() => toast.success('Policy opened')}>
