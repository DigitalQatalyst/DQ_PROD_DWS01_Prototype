...
import { BarChart3, BookOpen, Boxes, FileText, MessageSquare, Users } from 'lucide-react';
...
export function D4MarketplaceLandingPage() {
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 py-8">
      <div className="mb-8">
        <div className="text-xs font-bold uppercase tracking-wider text-text-muted">Marketplace / {content.title}</div>
        <h1 className="mt-1 text-3xl font-bold text-primary">{content.title}</h1>
