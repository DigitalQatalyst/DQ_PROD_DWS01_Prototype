  ...
  children: [
    {
      ...
      icon: Compass,
      flag: 'orientation.gettingStarted',
      visibleTo: ALL_ROLES,
      children: [
        { id: 'home', label: 'Home', route: '/home', flag: 'orientation.home', visibleTo: ALL_ROLES },
      ],
    },
    {
      id: 'quick-links',
      ...
      icon: Link2,
      flag: 'orientation.quickLinks',
      visibleTo: ALL_ROLES,
      children: [
        { id: 'dashboard', label: 'My Dashboard', route: '/dashboard', flag: 'orientation.myDashboard', visibleTo: ALL_ROLES },
        { id: 'my-work', label: 'My Work', route: '/tasks/my-work', flag: 'orientation.myWork', visibleTo: ALL_ROLES },
        { id: 'ai-cockpit', label: 'AI Cockpit', route: '/ai-cockpit', flag: 'orientation.aiCockpit', visibleTo: ALL_ROLES },
      ],
    },
  ],
};
...
export const servicesFeatureArea: NavItem = {
  ...
  children: [
    ...
    },
    {
      ...
      route: '/services/request-queues',
      icon: Inbox,
      flag: 'services.requestQueues',
      visibleTo: ALL_ROLES,
      children: [
        { id: 'central-support-queue', label: 'Central Support Queue', route: '/services/request-queues/central-support-queue', flag: 'services.centralSupportQueue' },
        { id: 'fulfilment-owner-queue', label: 'Fulfilment Owner Queue', route: '/services/request-queues/fulfilment-owner-queue', flag: 'services.fulfilmentOwnerQueue' },
        { id: 'assigned-requests', label: 'Assigned Requests', route: '/services/request-queues/assigned-requests', flag: 'services.assignedRequests' },
        { id: 'pending-information', label: 'Pending Information', route: '/services/request-queues/pending-information', flag: 'services.pendingInformation' },
        { id: 'sla-queue-view', label: 'SLA Queue View', route: '/services/request-queues/sla-queue-view', flag: 'services.slaQueueView' },
        { id: 'closure-review-queue', label: 'Closure Review Queue', route: '/services/request-queues/closure-review-queue', flag: 'services.closureReviewQueue' },
      ],
    },
  ],
};
  ...
  children: [
    {
      ...
      visibleTo: ALL_ROLES,
      children: [
        { id: 'my-tracker-overview', label: 'My Tracker Overview', route: '/tracker/my-tracker-overview', flag: 'trackers.myTrackerOverview' },
        { id: 'team-tracker-overview', label: 'Team Tracker Overview', route: '/tracker/team-tracker-overview', flag: 'trackers.teamTrackerOverview' },
        { id: 'tracker-insights', label: 'Tracker Insights', route: '/tracker/tracker-insights', flag: 'trackers.trackerInsights' },
      ],
    },
  ],
};
  ...
  children: [
    {
      ...
      visibleTo: ["PlatformAdmin"],
      children: [
        { id: 'marketplace-content', label: 'Marketplace Content', route: '/admin/content-management/marketplace-content', flag: 'platformAdmin.marketplaceContent' },
        { id: 'service-content', label: 'Service Content', route: '/admin/content-management/service-content', flag: 'platformAdmin.serviceContent' },
        { id: 'tracker-content', label: 'Tracker Content', route: '/admin/content-management/tracker-content', flag: 'platformAdmin.trackerContent' },
        { id: 'analytics-content', label: 'Analytics Content', route: '/admin/content-management/analytics-content', flag: 'platformAdmin.analyticsContent' },
      ],
    },
  ],
};
